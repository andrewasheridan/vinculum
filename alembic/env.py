...
async def run_migrations_online() -> None:
    ...
    """
    configuration: dict[str, Any] = config.get_section(config.config_ini_section, default={})
    configuration["sqlalchemy.url"] = settings.db.URI.unicode_string()
